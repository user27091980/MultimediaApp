...
interface MultimediaApiService {
    ...
    suspend fun getDiscographyByLabel(@Path("discografica") recordLabel: String): Response<BandDTO>

    @GET("json/componentes/{componentes}")
    suspend fun getComponents(@Path("componentes") components: String): Response<BandDTO>

    @GET("json/discografia")
    suspend fun getDiscography(@Query("ids") discographyIds: List<String>): Response<BandDTO>

    @GET("json/links")
    suspend fun getLinks(@Query("ids") albumLinks: List<String>): Response<BandDTO>

    @GET("json/imagenes/main")
    suspend fun getImagesMain(): Response<List<MainDTO>>

    @GET("json/discos")
    suspend fun getAlbumImages(@Query("ids") albumImages: List<String>): Response<BandDTO>
